...
<head>
    ...
    <!-- CSS -->
    <link rel="stylesheet" href="${pageContext.request.contextPath }/assets/css/errors/topbar(css).css">
...
<%-- 	                <li><a href="${pageContext.request.contextPath }/user/userEdit"> 내 정보수정 </a></li> --%>
	                ...
	                <li><a class="list" href="#"> 찜 목록 </a></li>
	 ...
	 <!-- 로고 시작 -->
        ...
        <form action="${pageContext.request.contextPath }/product/searchKeyword">
           <div class="top_menu_search_area">
               ...
               <input type="submit" class="top_menu_search_input" id="top_search_icon">
           </div>
